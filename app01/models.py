...
class ClassList(models.Model):
    ...
    teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo', related_name='teach_classes',limit_choices_to={"depart__code":1212})
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',limit_choices_to={"depart__code":1234})
...
class ConsultDestribution(models.Model):
    """
    客户分配表
    """
    customer = models.ForeignKey(verbose_name="客户id", related_name="cs",to='Customer')
    consultant = models.ForeignKey(verbose_name="跟踪人", related_name="con",to='UserInfo',limit_choices_to={"depart_id":1001})
    date = models.DateField(verbose_name="跟进日期", auto_now_add=True)
    status_choice = (
        (1,"正在跟进"),
        (2,"已成单"),
...
class Balance(models.Model):
    ...
    销售的权重表
    """
    user = models.ForeignKey(verbose_name='用户id',to='UserInfo',limit_choices_to={"depart_id":1001})
...
class CourseRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo',limit_choices_to={"depart_id":1212})
