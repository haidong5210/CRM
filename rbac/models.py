...
class Group(models.Model):
    ...
    权限组名称表
    """
    name = models.CharField(verbose_name="权限组名称",max_length=32)
    menue = models.ForeignKey(verbose_name="菜单名称",to="Menue")
...
class Permission(models.Model):
    ...
    menu_gp = models.ForeignKey(verbose_name="组内菜单",to="Permission",null=True,blank=True,related_name="xm")
